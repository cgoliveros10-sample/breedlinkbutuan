...
(function () {
  ...
  window.settingsSendEmailOtp = async function () {
    ...
    try {
      ...
      window.sessionStorage.setItem('breedlink_ce_email', newEmail);
  ...
  window.settingsVerifyEmailOtp = async function () {
    ...
    const newEmail = _spPendingNewEmail || window.sessionStorage.getItem('breedlink_ce_email');
    clearStatus('sp-email-otp-status');
    ...
    try {
      ...
      window.sessionStorage.removeItem('breedlink_ce_email');
  ...
  window.settingsSendUnameOtp = async function () {
    ...
    try {
      ...
      window.sessionStorage.setItem('breedlink_cu_uname', newUname);
  ...
  window.settingsVerifyUnameOtp = async function () {
    ...
    var newUname = _spPendingNewUname || window.sessionStorage.getItem('breedlink_cu_uname');
    clearStatus('sp-uname-otp-status');
    ...
    try {
      ...
      window.sessionStorage.removeItem('breedlink_cu_uname');
