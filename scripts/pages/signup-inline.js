...
var currentStep = 1;
    ...
    async function createAccount() {
      ...
      try {
        ...
        // Write to BOTH storages: sessionStorage is cleared on tab close, so localStorage
        // acts as a fallback if the user reloads the verify page before entering the code.
        ...
        localStorage.setItem('breedlink_pending_signup', pendingPayload);
        ...
        if (signUpData.session) {
          await window.supabase.from('profiles').upsert({
            ...
            bio: '', tags: [],
            contact: { email: email, phone: '', location: 'Butuan City, Philippines' },
          ...
          // Profile created — clear pending data from both storages
