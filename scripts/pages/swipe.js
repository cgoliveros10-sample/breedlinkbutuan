...
async function showPetDetails(animalId) {
    ...
    content.innerHTML = `
        ...
        <div style="padding:0 16px 12px;">
            <button class="message-owner-btn" onclick="(function(){var inSubfolder=window.location.pathname.includes('/pages/');window.location.href=(inSubfolder?'':'pages/')+'profile.html?user=${animal.user_id}';})()" style="background:var(--bg-secondary);color:var(--text-primary);margin:0;width:100%;">
                👤 See Full Profile
            </button>
        </div>
